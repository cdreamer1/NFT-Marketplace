...
contract NFTAuction is Ownable, ReentrancyGuardUpgradeable {
    ...
    function placeBid(
        ...
        require(
            ...
            "ERC20 method used for NFT auction"
        );
        ...
        nonReentrant
    {
        ...
        (address minter, uint256 royaltyFee) = NFTWallet(_nftAddress).royaltyInfo(_tokenId, payAmount);
        if (royaltyFee > 0) {
